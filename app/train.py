...
MODEL_INPUT_WIDTH = 140
MODEL_INPUT_HEIGHT = 140
MODEL_INPUT_DEPTH = 3
...
def add_input_distortions(flip_left_right, random_crop, random_scale,
    ...
    Brief:
        ...
        kind of variations we expect in the real world, and so can help train-A the
...
def main(_):
    ...
    with tf.Session(graph=graph) as sess:
        ...
        train_writer = tf.summary.FileWriter(FLAGS.summaries_dir + '/train-A',
                                         sess.graph)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default='C:\\Users\\Acer\\OneDrive\\Desktop\\TRAIN\\',
        help='Path to folders of labeled images.'
        )
    parser.add_argument(
        '--output_graph',
        type=str,
        default='logsold/output_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--output_labels',
        type=str,
        default='logsold/output_labels.txt',
        help='Where to save the trained graph\'s labels.'
        )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='logsold/retrain_logs',
        help='Where to save summary logsold for TensorBoard.'
        )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help='How many images to train-A on at a time.'
        )
    parser.add_argument(
        '--test_batch_size',
        type=int,
